                ...
                if (bluetoothAdapter == null) {
                    ...
                    if (pairedDevices.size() > 0) {
                        ...
                        for (BluetoothDevice device: pairedDevices) {
                            ...
                            //If we find the device with the name "MOBILE-FETOSCOPE" and MAC address "00:22:11:30:C5:62"
                            //We assign the device value to the Global variable BluetoothDevice
                            //We enable the button "Connect to HC 05 device"
                            if (deviceName.equals("MOBILE-FETOSCOPE") && deviceHardwareAddress.equals("00:22:11:30:C5:62")) {
                                Log.d(TAG, "MOBILE-FETOSCOPE found with correct MAC address");
                                arduinoUUID = device.getUuids()[0].getUuid();
                                arduinoBTModule = device;
                                //Device Found, enabling the button to read results
